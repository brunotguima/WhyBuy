...
<div class="container">
    ...
    <h2 class="center text-principal"><span class="orange-text">SOBRE NÓS</span><h2>
            ...
            <div class="collapsible-header z-depth-4 orange darken-2"><i class="material-icons">desktop_windows</i>Bruno Guimarães</div>
        ...
        <li class ='white-text'>
            ...
            <div class="collapsible-header z-depth-4 orange darken-2"><i class="material-icons">share</i>Filício Rocha</div>
        ...
        <li class ='white-text'>
            ...
            <div class="collapsible-header z-depth-4 orange darken-2"><i class="material-icons">brush</i>Luana Rondon</div>
        ...
        <li class ='white-text'> 
            ...
            <div class="collapsible-header z-depth-4 orange darken-2"><i class="material-icons">web</i>Gabriel Pereira</div>
        ...
        <li class ='white-text'>
            ...
            <div class="collapsible-header z-depth-4 orange darken-2"><i class="material-icons">whatshot</i>Gustavo Borborena</div>
        ...
        <li class ='white-text'>
            ...
            <div class="collapsible-header z-depth-4 orange darken-2"><i class="material-icons">library_books</i>Milena Cavallaro</div>
            ...
            <div class="collapsible-header z-depth-4 orange darken-2"><i class="material-icons">library_books</i>Juliana Ferreira</div>

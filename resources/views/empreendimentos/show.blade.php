...
<div class="container">
				...
				<div style="width:450px; height:350px;">
					<div class="card-panel orange">
						<div class="row center">
							<h6 for="nomeFantasia" class="control-label white-text ">Nome Fantasia:</label>
							</h6>
	...
	<div class="row">
		...
		<div class="center">
			<form id="create_promo" action="{{route('promocao.create')}}" method="get">
				@foreach($empreendimento as $emp)
                <input type="hidden" id="emp_id" name="emp_id" value="{{$emp->id}}">
                @endforeach
        <a class="btn-floating btn-large waves-effect waves-light orange" onClick="goCreatepromo()">
    ...
    <script>
function goCreatepromo() {
    document.getElementById("create_promo").submit();
}
</script>
	@endsection

            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('dateNasc') ? ' has-error' : '' }}">
                            <label for="dateNasc" class="col-md-4 control-label">Data de Nascimento</label>

                            <div class="col-md-6">
                                <input id="dateNasc" type="date" class="form-control" name="dateNasc" value="{{ old('dateNasc') }}" required>

                                @if ($errors->has('dateNasc'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('dateNasc') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>

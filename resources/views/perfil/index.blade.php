	...
	@if ($mainPerfil->perfil != null)
		...
		<div class="row">
			...
			<br />
				...
				<img class="circle" width="125" height="125" src="{{asset('/images/perfils')}}/{{$mainPerfil->perfil->image}}">
				<br />
				<br />
				...
				<div class="col l8 ">
					<h4 class="center-align white-text">MINHAS INFORMAÇÕES</h4>
					<li class="divider"></li>
					...
					<ul>
						<div class="row col s12">
							<div align="center">
								<li>
									<a class="grey-text text-lighten-3 col s12">
										<label for="email" class="control-label white-text"> Seu Email:</label>
										<h7 class="white-text">{{$mainPerfil->email}}
											<h7>
									</a>
								</li>
								<br />
								...
								<li>
									<a class="grey-text text-lighten-3 col s12">
										...
										<h7 class="white-text">{{$mainPerfil->dateNasc}}
											<h7>
									</a>
								</li>
								<br />
								...
								<li>
									<a class="grey-text text-lighten-3 col s12">
										...
										<h7 class="white-text">{{$mainPerfil->perfil->sexo}}
											<h7>
									</a>
								</li>
								<br />
								...
								<li>
									<a class="grey-text text-lighten-3 col s12">
										...
										<h7 class="white-text">{{$mainPerfil->perfil->rg}}
											<h7>
									</a>
								</li>
								<br />
								...
								<li>
									<a class="grey-text text-lighten-3 col s12">
										...
										<h7 class="white-text">{{$mainPerfil->perfil->cpf}}
											<h7>
									</a>
								</li>
								<br />
								...
								<li>
									<a class="grey-text text-lighten-3 col s12">
										...
										<h7 class="white-text">{{$mainPerfil->perfil->telUm}}
											<h7>
									</a>
								</li>
								<br />
								...
								<li>
									<a class="grey-text text-lighten-3 col s12 ">
										...
										<h7 class="white-text">{{$mainPerfil->perfil->cell}}
											<h7>
									</a>
								</li>
